  ...
  return (
    <Slide bg="cream" id={id} anim="stagger">
      <div className="w-full h-full flex flex-col items-center justify-center text-center">
        {/* Thin gold rule top */}
        <div className="deck-animate w-12 h-px bg-[#D4A853]/40 mb-10" />

        {/* Kicker */}
        <span className="deck-animate kicker text-[#D4A853] mb-6">{kicker}</span>
        ...
        <div className="deck-animate w-12 h-px bg-[#D4A853]/40 mt-10" />
      </div>
    </Slide>
  );
}
