    ...
    <Slide bg="cream" id="phone-test" anim="stagger">
      <div className="w-full h-full grid grid-cols-12 gap-8 items-center">
        ...
        <div className="col-span-6 flex flex-col justify-center pl-[2vw]">
          <span className="deck-animate kicker text-[#0A0A0A] mb-4">TEST SLIDE — DELETE LATER</span>
          ...
          <ol className="deck-animate space-y-3 max-w-[440px] font-sans text-[14px] text-[#0A0A0A]/75 leading-[1.6]">
            <li><span className="text-[#0A0A0A] font-semibold">1.</span> Click or tap the phone on the right.</li>
            <li><span className="text-[#0A0A0A] font-semibold">2.</span> Phone enlarges to centre with backdrop blur.</li>
            <li><span className="text-[#0A0A0A] font-semibold">3.</span> Scroll inside the phone — content moves; deck stays put.</li>
            <li><span className="text-[#0A0A0A] font-semibold">4.</span> Watch for subtle 3D tilt as you scroll.</li>
            <li><span className="text-[#0A0A0A] font-semibold">5.</span> Click outside, press Esc, or tap × to close.</li>
            <li><span className="text-[#0A0A0A] font-semibold">6.</span> Deck navigation resumes immediately.</li>
          </ol>
