    ...
    <Slide bg="dark" id="stat-wall" anim="stat-counter">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div className="flex gap-[8vw] items-start">
          <StatBlock value={copy.stat1.value} label={copy.stat1.label} color="gold" size="large" />
          <StatBlock value={copy.stat2.value} label={copy.stat2.label} suffix={copy.stat2.suffix} color="gold" size="large" />
          <StatBlock value={copy.stat3.value} label={copy.stat3.label} color="gold" size="large" />
        </div>
